var app = angular.module('mockNews', ['ui.router']);
...
app.factory('auth', ['$http', '$window', function($http, $window) {
    ...
    auth.saveToken = function(token) {
        $window.localStorage['mock-news-token'] = token;
    };
    
    auth.getToken = function() {
        return $window.localStorage['mock-news-token'];
    };
    ...
    auth.logOut = function() {
            console.log("logout");
        $window.localStorage.removeItem('mock-news-token');
    };
